<template>
	<div id="g-apoiosul-box" class="ai2html ai2html-box-v5">
		<div id="g-apoiosul-Prancheta_1" class="g-artboard" data-aspect-ratio="1.439" data-min-width="992">
			...
			<div id="g-ai0-5" class="g-legenda g-aiAbs g-aiPointText" style="top:96.2272%;margin-top:-10.3px;left:70.9171%;width:29px;">
				<p class="g-pstyle4">0</p>
			</div>
			<div id="g-ai0-6" class="g-legenda g-aiAbs g-aiPointText" style="top:96.2272%;margin-top:-10.3px;left:73.8476%;width:42px;">
				<p class="g-pstyle4">500</p>
			</div>
			<div id="g-ai0-7" class="g-legenda g-aiAbs g-aiPointText" style="top:96.2272%;margin-top:-10.3px;left:77.1784%;width:49px;">
				<p class="g-pstyle4">1000</p>
			</div>
			<div id="g-ai0-8" class="g-legenda g-aiAbs g-aiPointText" style="top:96.2272%;margin-top:-10.3px;left:82.5754%;width:31px;">
